...
namespace TrainingFPTCo.Models.Queries
{
    public class CourseQuery
    {
        ...
        /*internal IEnumerable<CourseDetail?> GetAllDataCourses(object? value1, object? value2)
        {
        ...
        //ket noi hien thi add topic
        public IEnumerable<CourseDetail> GetAllDataCourses(object? value1, object? value2)
        {
            List<CourseDetail> courses = new List<CourseDetail>();
            using (SqlConnection connection = Database.GetSqlConnection())
            {
